...
- `plans/`: ホームページ制作5プランとDX・AI支援の参考価格ページ
...
- 料金プランの正本を確認する: 現在の公開価格は2026-08-09時点の暫定承認版。旧README記載の `../00-共通/AmorWorks_料金プラン.md` は現在見つからないため、正式な正本の場所を確定してから更新する
- 料金プラン画像を差し替える: `assets/plan-*.jpg` を更新する。元画像は公開用リポジトリ外で管理する
- DX・AIサービスの説明を変える: `services/index.html` の `#dx-ai`
- DX・AIサービスの正本を確認する: 公開中の参考価格とPremium割引は2026-08-09時点の暫定承認版。旧README記載の `../00-共通/AmorWorks_DX・AIサービス.md` は現在見つからないため、正式な正本の場所を確定してから更新する
